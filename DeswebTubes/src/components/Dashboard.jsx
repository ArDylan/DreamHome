...
function Dashboard() {
  ...
  const settings = {
    ...
    infinite: true,
    speed: 500,
    slidesToShow: 9, // Jumlah logo yang ditampilkan sekaligus
    slidesToScroll: 1,
  };
    ...
    <div className="min-h-screen">
         ...
         <div className="container mx-auto ">
           {/* Sebelum Card List */}
            ...
            <div className="w-1/8">
                ...
                <p className="text-black" style={{ fontSize: "18px" }}>See More</p>
            </div>
            </div>
      ...
      <section style={{ backgroundColor: "#FAF8F8", height: "557px" }} className="py-5">
         <div className="container mx-auto ">
            ...
            <p className="text-black" style={{ fontSize: "18px" }}>Temukan bermacam Properti berkelas disini</p>
            </div>
